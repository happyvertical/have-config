...
| Chat and collaboration | Zulip | `https://chat.happyvertical.com` | Use Zulip as the primary team chat and agent-response channel. Hermes agents should enable `platforms.zulip.enabled: true`, connect with bot credentials, and long-poll `/api/v1/events`. |
